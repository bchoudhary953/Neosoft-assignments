            ...
            <div class="card ">
                <div class="card-body register-card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{url('/admin/edit-coupon/'.$coupons->id)}}">
                        ...
                        <div class="input-group mb-3">
                            Amount Type:
                            <select name="amount_type" id="amount_type" class="form-control ml-3">
                        ...
                        <div class="input-group mb-3">
                            Expiry Date:
                            <input type="text" class="form-control ml-3" value="{{$coupons->expiry_date}}" id="datepicker" name="expiry_date" required>
                        </div>
                        <div class="row">
                            <!-- /.col -->
