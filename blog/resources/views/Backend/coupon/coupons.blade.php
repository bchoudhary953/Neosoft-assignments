    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div>
                    <a class="btn btn-primary m-3 p-1" style=" width:120px;" href="{{url('/admin/add-coupon')}}"><i class="fa fa-plus"></i> Add Coupon</a> 
                    <a href="/exportCoupon"> <button class="btn btn-primary mt-2" style="margin-left: 700px;">Export</button></a>
                </div>
