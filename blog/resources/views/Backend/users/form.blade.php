                    ...
                    @endif
                     <form method="POST" action="/role-register-update/{{$users->id}}">
                        ...
                        <div class="input-group mb-3">
                            First Name:
                            <input type="text" id="first_name" class="form-control ml-3 @error('name') is-invalid @enderror" name="first_name" value="{{$users->first_name}}" required autocomplete="name" autofocus placeholder="First name">
                            @error('first_name')
                        ...
                        <div class="input-group mb-3">
                            Last Name:
                            <input type="text" id="last_name" class="form-control ml-3 @error('name') is-invalid @enderror" name="last_name" value="{{$users->last_name }}" required autocomplete="name" autofocus placeholder="Last name">
                            @error('last_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
