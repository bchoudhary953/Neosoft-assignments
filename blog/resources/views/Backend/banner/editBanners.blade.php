            ...
            <div class="card-body register-card-body">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{url('/edit-banners/'.$banner->id)}}">
                    ...
                    <div class="input-group mb-3">
                        Name:
                        <input type="text" id="banner_name" class="form-control ml-3" name="banner_name" value="{{$banner->name}}" required autocomplete="banner_name" autofocus>
                    </div>
                    <div class="input-group mb-3">
                        Text Style:
                        <input type="text" id="text_style" class="form-control ml-3" name="text_style" value="{{$banner->text_style}}" required autocomplete="text_style" autofocus>
                    </div>
                    <div class="input-group mb-3">
                        Content:
                    ...
                    <div class="input-group mb-3">
                        Link:
                        <input type="text" id="link" class="form-control ml-3" name="link" required autocomplete="link" autofocus value="{{$banner->link}}">
                    </div>
                    <div class="input-group mb-3">
                        Sort Order:
                        <input type="text" id="sort_order" class="form-control ml-3" name="sort_order" required autocomplete="sort_order" value="{{$banner->sort_order}}"autofocus >
                    </div>
                    <div class="input-group mb-3">
                        Banner Image:
