                    ...
                    <table class="table table-head-fixed text-nowrap" id="example1" style="width: 950px;">
                        ...
                        @foreach($product as $row2)
                            <tr>
                                ...
                                <td>{{$row2->price}}</td>
                                <td>
                                    <input type="checkbox" style="width: 20px;" name="status" class="FeatureStatus" data-toggle="toggle" rel="{{$row2->id}}" data-on="Enabled" data-off="Disabled" data-onstyle="success" data-offstyle="danger"  @if($row2['feature_status']=="1")checked @endif>
                                ...
                                <td><a href="/admin/add-attribute/{{$row2->id}}"><button class="btn btn-warning mr-2"><i class="fas fa-list"></i></button></a>
                                    ...
                                    <a href="/admin/delete-product/{{$row2->id}}"><button class="btn btn-danger" ><i class="fas fa-trash"></i></button></a></td>
                            </tr>
                        @endforeach
