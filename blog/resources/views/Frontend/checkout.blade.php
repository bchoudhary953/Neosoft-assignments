            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopper-info">
                        ...
                        @endforeach
                        <h4>Address:</h4>
                        <input type="text" class="form-control" name="billing_first_name" id="billing_first_name" placeholder="Name">
                        ...
                        <input type="text" class="form-control" name="billing_mobile_no" id="billing_mobile_no" placeholder="Mobile number">
                ...
                <div class="col-sm-6">
                    <div class="shopper-info">
                        ...
                        @endforeach
                        <h4>Address:</h4>
                            <input type="text" class="form-control" id="shipping_first_name" name="shipping_first_name" placeholder="Name ">
                            ...
                            <input type="text" class="form-control" id="shipping_mobile_no" name="shipping_mobile_no" placeholder="Mobile Number">
