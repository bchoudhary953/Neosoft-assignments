...
<div class="container">
 <div class="row justify-content-end" style="float:right; margin-right:17px; margin-bottom:30px;">
    <div class="col-6 px-2">
      <a href="Add-Category.php"><button type="button" class="btn p-2" style="background-color:#9acd32; font-size:20px; color:white">Create Category</button></a>
    </div>
	...
	if($resultCheck >0){
		while($row = mysqli_fetch_assoc($result)){
		   echo "
			...
			<td><a href = delete1.php?ID=".$row['ID']."><button type='button' class='btn mr-2' style='background-color:#9acd32; color:white'><i class='fa fa-trash'></i></i></button> </a><a href = 'Edit-Category.php?ci=$row[ID]&cn=$row[category_name]'><button type='button' class='btn btn-danger mr-2' ><i class='fa fa-pencil'></i></i></button> </a></td>";
			echo "</tr>";
