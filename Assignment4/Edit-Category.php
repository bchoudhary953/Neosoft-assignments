...
<form class="border border-secondary" action="" method="GET" style="margin:65px; color:#808080; PADDING:50PX; border:500px;" name="myForm">
  <div class="form-group" style="display:none">
    ...
    <input type="text" class="form-control border border-secondary" style="width:400px;" value="<?php echo "$_GET[ci]" ?>" id="category_id" name="category_id">
    
  </div>
  <div class="form-group">
    <label for="category" style="font-size:16px;">Category Name</label>
    <input type="text" class="form-control border border-secondary" style="width:400px;" value="<?php echo "$_GET[cn]" ?>" id="category" name="category">
...
$sql= "UPDATE category_list SET category_name='$category' WHERE ID='$category_id';";
