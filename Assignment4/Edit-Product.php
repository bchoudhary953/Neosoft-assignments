...
<div class="container">
<form class="border border-secondary" action="" method="GET" style="margin:65px; color:#808080; PADDING:50PX; border:500px;" name="myForm">
  <div class="form-group"style="display:none">
    <label for="pname" style="font-size:16px;">Product Name</label>
    <input type="text" value="<?php echo "$_GET[pid]" ?>" name="pid" class="form-control border border-secondary" style="width:400px;" id="pid">
  </div>
  <div class="form-group">
    <label for="pname" style="font-size:16px;">Product Name</label>
    <input type="text" value="<?php echo "$_GET[pn]" ?>" name="pname" class="form-control border border-secondary" style="width:400px;" id="pname">
  </div>
  <div class="form-group">
    <label for="price"  style="font-size:16px;">Product Price</label>
    <input type="text" value="<?php echo "$_GET[pp]" ?>" name="price" class="form-control border border-secondary" style="width:400px;" id="price">
  </div>
  <div class="form-group">
   
    <label for="img"  style="font-size:16px;">Upload Image</label>
    <input type="file" value="<?php echo "$_GET[pi]" ?>" name="img" class="form-control-file border border-danger p-2 col-5"  id="img">
  ...
  <div class="form-group">
	...
	<div class="box">
		...
		<?php if($pc == $row1[1]){echo "selected";}?>
...
$sql= "UPDATE product_list SET product_name='$pname', product_price='$price',image='$img',category='$category' WHERE id='$pid';";
